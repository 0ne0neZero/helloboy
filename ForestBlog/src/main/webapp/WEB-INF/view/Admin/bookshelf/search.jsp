    ...
    <form id="bookForm" method="post">
        <div class="layui-form-item">
            <div class="layui-input-block">
                ...
                <button class="layui-btn" lay-filter="formDemo" onclick="queryBook()">搜索</button>
    ...
    <c:choose>
        ...
        <c:when test="${articleSearchVoList[0].page.totalCount!=0}">
            <table class="layui-table">
                ...
                <tbody>
                <c:forEach items="${mhfind}" var="a">
                    <tr>
                        <td><input type="checkbox" name="ids" value="${a.bookId}"></td>
                        <td>${a.bookId}</td>
                         <td>${a.bookName}</td>
                        <td>${a.bookAuthor}</td>
                        <td>
                            <fmt:formatDate value="${a.bookPostTime}" pattern="YY年MM月dd日 HH:mm"/>
                        </td>
                        <td>
							<a href="/admin/article/edit/${a.bookId}"
								class="layui-btn layui-btn-mini">编辑</a> 
							<a href="javascript:void(0)"
								onclick="deleteBook(${a.bookId})"
